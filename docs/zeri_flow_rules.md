...
Note: the browser entry point that drives this flow is the Firefox Playwright middleware documented in [`docs/browser_profile_flow.md`](browser_profile_flow.md).
