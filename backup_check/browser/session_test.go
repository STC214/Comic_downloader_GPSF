...
func TestLaunchDataAndContextData(t *testing.T) {
	...
	m = m.WithBrowserPath(filepath.Clean(filepath.FromSlash("F:/Project/comic_downloader_GO_Playwright_stealth/runtime/firefox/firefox.exe")))
	...
	if got, want := launch.ExecutablePath, filepath.Clean(filepath.FromSlash("F:/Project/comic_downloader_GO_Playwright_stealth/runtime/firefox/firefox.exe")); got != want {
